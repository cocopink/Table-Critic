...
run_table_fv() {
    ...
    local critic_results_dir="${BASE_CRITIC_RESULTS_FV}/${model}"
    ...
    # if [ $? -ne 0 ]; then
    #     echo -e "${RED}错误: critic/TableFV/main.py 执行失败${NC}"
    #     exit 1
    # fi
    
    # echo -e "${GREEN}✓ TableFV Critic 阶段完成${NC}"
    
    # ==================== 阶段 3: Refine ====================
    echo ""
    echo -e "${YELLOW}=========================================="
    echo "TableFV 阶段 2-3: Refine"
    echo -e "==========================================${NC}"
