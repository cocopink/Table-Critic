...
from critic.TableQA.tools.read_pkl import read_pkl
import pickle


if __name__ == "__main__":
    data_type = "FV"
    data_file = "/home/ubuntu/mnt/lx/Table-Critic/results/refine/tabfact/qwen3:32b/final_result.pkl" #final_results.pkl
