...
Statement:
liam dickinson has one fa cup and one fl trophy
...
Statement:
you're gettin' to me again is at the top of the us chart
...
def critic_tree_init(file_path = "critic/TableFV/tools/few_shot_critic.json"):
