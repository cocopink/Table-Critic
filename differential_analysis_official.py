...
def main():
    print("=" * 60)
    print("横向对比分析：当前项目特有错误案例（使用官方评估函数）")
    print("=" * 60)
    ...
    report.append("**方法**: 使用官方评估函数（wikitq_match_func）判断bad case\n\n")
