...
nohup /home/ubuntu/mnt/lx/M_TC/Table-Critic/run_ollama_model.sh -t FV -m qwen3:32b -u False -n -1 -c 8  > logs/m_0317FV_32b_new.log 2>&1 &
pid=$!
wait $pid
echo "1 task finished."

echo "Starting 2 task (QA with qwen3:32b)..."
nohup /home/ubuntu/mnt/lx/M_TC/Table-Critic/run_ollama_model.sh -t QA -m qwen3:32b -u False -n -1 -c 8  > m_0317QA_32b_new.log 2>&1 &
pid=$!
wait $pid
