...
echo "Starting 1 task (FV with 0403FV_gpt5.4)..."
nohup ./run_FV.sh > logs/0403FV_gpt5.4.log 2>&1 &
pid=$!
wait $pid
echo "1 task finished."

echo "Starting 1 task (FV with 0403QA_gpt5.4)..."
nohup ./run_QA.sh > logs/0403QA_gpt5.4.log 2>&1 &
pid=$!
wait $pid
echo "2 task finished."
