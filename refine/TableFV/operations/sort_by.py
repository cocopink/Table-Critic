...
sort_column_demo = """To tell the statement is true or false, we can first use f_sort_column() to sort the values in a column to get the order of the items. The order can be "large to small" or "small to large".
