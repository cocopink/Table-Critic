...
add_column_demo = """To answer the question, we can use f_add_column() to add more columns to the table.
...
def add_column_func(
    sample, table_info, llm, llm_options=None, debug=False, skip_op=[], strategy="top", critic=None
):
    operation = {
