...
def _conduct_single_solver_mp_core(arg):
    ...
    try:
        ...
        print(f"QA-chain.py-_conduct_single_solver_mp_core Error in {idx}-th sample: {e}")
        return idx, None
...
def _dynamic_chain_exec_with_cache_mp_core(arg):
    ...
    try:
        ...
        print(f"QA-chain.py-_dynamic_chain_exec_with_cache_mp_core Error in {sample_id}: {e}", flush=True)
        return idx, None
...
def _critic_refine_with_cache_mp_core(arg):
    ...
    try:
        ...
        print(f"QA-chain.py-_critic_refine_with_cache_mp_core Error in {sample_id}: {e}", flush=True)
        return idx, None
...
def _judge_critic_refine_with_cache_mp_core(arg):
    ...
    try:
        ...
        import traceback
        print(f"QA-chain.py-_judge_critic_refine_with_cache_mp_core Error at stage '{current_stage}' for sample {sample_id}: {e}", flush=True)
