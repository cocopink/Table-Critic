@echo off
REM ================================================
REM Game-Driven Memory Evolution TableFV Framework
REM New FV Pipeline with Multi-Agent System
REM ================================================
...
set DATASET_PATH=thought/TableFV/data/tabfact/test.jsonl
set FIRST_N=3

REM Results Directory Configuration
set MODEL_DIR=qwen2.5-72b-instruct
set THOUGHT_RESULTS_DIR=results/%MODEL_DIR%/thought/tabfact
set REFINE_RESULTS_DIR=results/%MODEL_DIR%/refine/tabfact
...
echo ================================================
echo TableFV Multi-Agent Pipeline
echo ================================================
...
if errorlevel 1 (
    echo X Error in thought/TableFV/main.py
    exit /b 1
)
...
if errorlevel 1 (
    echo X Error in refine/TableFV/main_tree_based.py
    exit /b 1
)
...
echo ================================================
echo.
echo OK TableFV pipeline completed successfully!
