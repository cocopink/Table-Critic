...
# Game-Driven Memory Evolution TableFV Framework
# New FV Pipeline with Multi-Agent System
...
DATASET_PATH="thought/TableFV/data/tabfact/test.jsonl"
FIRST_N=10  # Process 10 samples

# Results Directory Configuration
MODEL_DIR="qwen2.5-72b-instruct"
THOUGHT_RESULTS_DIR="results/${MODEL_DIR}/thought/tabfact"
REFINE_RESULTS_DIR="results/${MODEL_DIR}/refine/tabfact"
...
echo "=================================================="
echo ""
echo "✓ TableFV pipeline completed successfully!"
